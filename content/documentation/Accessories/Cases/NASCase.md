...
![Internal Layout of the NAS Case](/documentation/images/NAS_Case_internals.jpg)
...
![You will need the PCIe to SATA adapter from the PINE64 store to connect your disks to your ROCKPro64 board. <span>https://</span>forum.pine64.org/showthread.php?tid=6932. WARNING: this adapter does not work well with two HDDs](/documentation/images/PCIetoSATA.png)
...
![The OMV WebGUI is easy to understand but also very robust. It offers easy installation of plugins](/documentation/images/OMVGUI.png)
...
![Correct Placement of the ROCKPro64 in the empty case](/documentation/images/ROCKPro64inNASCase.jpg)

![Front IO with IR and LED relay installed](/documentation/images/FrontIO.png)
...
![DC header on the ROCKPro64 for the power cable](/documentation/images/DC_Location.jpg)

![PCIe to SATA installed. Note the SATA connection orientation](/documentation/images/PCIeFittedSATAsockets.png)
...
![Bracket Orientation in the NAS Case](/documentation/images/Bracket_Orientation.png)
...
![The 80mm fan is a worthwhile addition to the NAS Case build](/documentation/images/80mmfan.png)
...
![Complete assembly of the NAS Case](/documentation/images/NASCAsewithdrives.jpg)

![Top view of a complete NAS Case Assembly](/documentation/images/TopViewAssembly.png)
