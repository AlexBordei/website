...
![Close-up picture of the two identical switches the issue originates from](/documentation/images/Martjin_VCONN_switches_1.1.jpg)

![Excerpt from the PinePhone schematic showing the two components.](/documentation/images/Schematic_VCONN_switches.png)
...
![width=130](/documentation/images/Pinephone_v1.1_VCONN_fix_diagram.svg))]]
