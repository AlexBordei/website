...
![width=200](/documentation/images/Kali-logo.png)
...
![width=100](/documentation/images/Luneos-logo-256.png)
...
![width=100](/documentation/images/Maemoleste-logo.png)
...
Most discussion occurs at  [ircs://irc.libera.chat:6697/#maemo-leste `#maemo-leste` on `irc.libera.chat`] and [this thread](https://talk.maemo.org/showthread.php?t=100192&page=60).
...
An unofficial [Debian](https://www.debian.org) build for ARM64 running with Phosh (developed by Purism, uses Wayland instead of Xorg).
...
![width=100](/documentation/images/nemo_mobile.png)
...
![width=100](/documentation/images/Oma-logo-22042013_300pp.png)
...
![width=100](/documentation/images/SLEM-OS-logo.png)
...
NOTE: Tow-Boot is required for installing the latest version of Ubuntu Touch (20.04) on the PinePhone. Instructions for installing Tow-Boot to the PinePhone can be found [here](https://tow-boot.org/devices/pine64-pinephoneA64.html). 
