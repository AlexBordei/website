...
|     |     |     |     |     |
| --- | --- | --- | --- | --- |
| + Power consumption at different voltages and frequencies | Configuration | Frequency | Voltage | Power (Screen 50%) |
| Stock | 1.152GHz | 1.30v | ~4.35w | Stock + Undervolt |
| 1.152GHz | 1.18v | ~3.65w | Overclock + Undervolt | 1.344Ghz |
...
|     |     |     |
| --- | --- | --- |
| + AXP803 PMIC voltage steps on DCDC2. | Voltage range | Step size |
| 0.50V-1.20V | 10mV | 1.22V-1.30V |
