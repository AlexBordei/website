...
![width=400](/documentation/images/AC_adaptor_polarity.png)

![width=300](/documentation/images/Nintendo-center-negative.png)
...
![Screen side: V2 on top](/documentation/images/PCP-Top-side-screen.jpg)
![Pinecone side: V2 on top](/documentation/images/PCP-Bottom-Side.jpg)
![MOSFET V2](/documentation/images/Pinecil_v2_MOSFET.JPG)
![width=302](/documentation/images/FUSB302-V2-02.JPG)
![_LDO_and_OP-Amp](/documentation/images/Pinecil_LDOandOP-Amp.png)
![ Under the OLED screen](/documentation/images/Under_OLED_screen01.png)
...
![Pinecil V1 has blue rubber. Newer Pinecil V2 has green rubber & Bluetooth LE chip](/documentation/images/Pinecil-V1andV2.png)
...
6. See the February 2022 [Community update here](https://www.pine64.org/2022/02/15/february-update-chat-with-the-machine/). The photo is incorrect in the article. It is _not_ a before and after photo.
   ...
   * The PCB with 2 small via holes and is harder to cut in the correct location to avoid damaging the holes. This is called the "whalecil" in community chat (looks like a whale).
   ![width=400](/documentation/images/Pinecil_V1_24V_Mod.png)
